    ...
    snack_docs = [
        {
            ...
            "endTime": s.end_time,
            "talkUrl": s.talk_url,
            "embedUrl": ai_ctx.embed_url,
            "thumbnailUrl": ai_ctx.thumbnail_url,
            "thumbnailUrlHd": ai_ctx.thumbnail_url_hd,
            "thumbnailUrlFullHd": ai_ctx.thumbnail_url_full_hd,
            "hlsUrl": ai_ctx.hls_url,
            "mp4Url": ai_ctx.mp4_url,
            "mediaExtractedAt": ai_ctx.media_extracted_at,
            "mediaExtractionVersion": ai_ctx.media_extraction_version,
            "mediaExtractionStatus": ai_ctx.media_extraction_status,
            "mediaExtractionError": ai_ctx.media_extraction_error,
            "language": language,
            "aiPipelineVersion": pipeline_version,
            "sourceHash": source_hash,
            "createdAt": now,
